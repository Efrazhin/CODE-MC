# Generated by Django 5.0.6 on 2024-11-06 13:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tamaño', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Tamaño')),
                ('unidad_medida', models.CharField(choices=[('Litros', 'L'), ('Milílitros', 'ml'), ('Centímetros cúbicos', 'cm³ - cc'), ('Kilogramos', 'kg'), ('Gramos', 'g'), ('Centímetros cúbicos', 'cm³ - cc'), ('Talla XS', 'Talla XS'), ('Talla S', 'Talla S'), ('Talla M', 'Talla M'), ('Talla L', 'Talla L'), ('Talla XL', 'Talla XL')], max_length=30, null=True, verbose_name='Unidad de medida')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empleado', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='miapp_CODEMC.empleado', verbose_name='Empleado')),
                ('jefe', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='remito', to='miapp_CODEMC.businessmanager', verbose_name='Remito')),
            ],
        ),
        migrations.CreateModel(
            name='DetalleRemito',
            fields=[
                ...
                ('cantidad', models.IntegerField(verbose_name='Cantidad')),
                ('descuento', models.DecimalField(blank=True, decimal_places=2, default=1.0, max_digits=5, verbose_name='Descuento (porcentaje)')),
                ('importe', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Importe')),
