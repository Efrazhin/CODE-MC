# Generated by Django 5.0.6 on 2024-10-28 10:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categorias', to='miapp_CODEMC.empresa')),
            ],
        ),
        migrations.CreateModel(
            name='Almacen',
            fields=[
                ...
                ('telefono', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region='AR', verbose_name='Teléfono')),
